...
typedef fsu::BST<ElementType> BST;
typedef fsu::BST<ElementType>::Iterator Iterator;
typedef fsu::BST<ElementType>::LevelorderIterator LevelorderIterator;
...
// const int tcw = 14; // traversal column width
