...
const int c1 = 20, c2 = 12, c3 = 7, c4 = 10; // column widths
int main(int argc, char* argv[])
{
  ...
  *isptr >> e;
  ...
  std::cout << std::setw(c1) << "algorithm"
            ...
            << std::setw(c3) << "size" << std::setw(c4) << "log size" << " [ceiling]"
            << '\n'
            << std::setw(c1) << "---------" 
            << std::setw(c2) << "---------"
            << std::setw(c2) << "---------"
            << std::setw(c2) << "---------"
            << std::setw(c3) << "----" << std::setw(c4) << "--------"
            << '\n';
  ...
  std::cout << std::setw(c1) << "fsu::g_lower_bound" 
            ...
            << std::setw(c3) << deque.Size() << std::setw(c4) << (size_t)ceil(log2(deque.Size()))
            << '\n';
