...
setenv COURSE cop4530p
setenv ASSIGNMENT homework4
setenv FILES "oaa.h wordbench2.h wordbench2.cpp log.txt"
...
if ($FAILED1 == 0 && $FAILED2 == 0 && $FAILED3 == 0) then
    ...
    echo "\e[1;34m\n*** SUBMISSION SENT SUCCESSFULLY ***.\n\nMake sure you receive two email responses (as mentioned in the course organizer).  Note that these will come to your CS email, not your FSU email.  Go here to learn how to check your CS email:  http://www.cs.fsu.edu/~lacher/courses/COP3330/Email.html\n\e[0m"
